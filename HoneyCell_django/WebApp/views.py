...
def add_contact(request):
    print("in the add_contact function.")
    ...
    if request.method == "GET":
        return render(request, 'WebApp/add_contact.html', context)
        ...
        if len(Contact.objects.filter(phone=phone)):
            errors.append("The phone already exist.")

            return render(request, 'WebApp/add_contact.html', context)

        if len(Contact.objects.filter(address=address)):
            errors.append("The address already exist.")

            return render(request, 'WebApp/add_contact.html', context)

        new_contact_instance = Contact(name=name,
                                       phone=phone,
                                       address=address)
...
def show_contacts(request):
    print("in the show_contacts function.")
    ...
    return render(request, 'WebApp/show_contacts.html', context)
